...
function gradeQuiz(candidateAnswers) {
 ...
 if (grade >= 80) {
  console.log(`Congratulations ${candidateName}, you scored ${grade}%, meaning you pass!`)
 } else {
  console.log(`Sorry ${candidateName}, your score of ${grade}% is not sufficient to pass.`)
 }
